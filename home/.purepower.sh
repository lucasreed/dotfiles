...
() {
  ...
  typeset -g POWERLEVEL9K_CUSTOM_CUDDLE_CLUSTER="zsh_cuddle_cluster"
  typeset -g POWERLEVEL9K_CUSTOM_CUDDLE_CLUSTER_BACKGROUND=none
  typeset -g POWERLEVEL9K_CUSTOM_CUDDLE_CLUSTER_FOREGROUND="blue"

  typeset -ga POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      dir vcs custom_cuddle_cluster)
  ...
  if (( ${PURE_POWER_USE_P10K_EXTENSIONS:-1} )); then
    ...
    typeset -g POWERLEVEL9K_RULER_FOREGROUND=$(_pp_c 5 237)
  else
